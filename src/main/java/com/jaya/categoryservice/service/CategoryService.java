package com.jaya.categoryservice.service;
...
public class CategoryService {
    ...
    public List<Expense> getOthersAndUncategorizedExpenses(User user) throws Exception {
    ...
    public List<Expense> getAllExpensesWithCategoryFlag(Integer userId, Integer categoryId) throws Exception {
    ...
    public List<Expense> getAllUserExpensesOrderedByCategoryFlag(
        ...
        if (sortBy.startsWith("expense.")) {
            ...
            allUserExpenses = expenseService.getExpensesByUserAndSort(userId, sort.toString());
        }
