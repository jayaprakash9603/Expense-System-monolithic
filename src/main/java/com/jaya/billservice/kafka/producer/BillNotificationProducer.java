package com.jaya.billservice.kafka.producer;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.jaya.billservice.kafka.events.BillNotificationEvent;
...
public class BillNotificationProducer extends NotificationEventProducer<BillNotificationEvent> {
    ...
    public BillNotificationProducer(@Qualifier("expenseObjectKafkaTemplate") KafkaTemplate<String, Object> kafkaTemplate,
