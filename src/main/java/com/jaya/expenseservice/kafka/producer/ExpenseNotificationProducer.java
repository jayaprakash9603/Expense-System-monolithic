package com.jaya.expenseservice.kafka.producer;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.jaya.expenseservice.kafka.events.ExpenseNotificationEvent;
...
public class ExpenseNotificationProducer extends NotificationEventProducer<ExpenseNotificationEvent> {
    ...
    public ExpenseNotificationProducer(
            @Qualifier("expenseObjectKafkaTemplate") KafkaTemplate<String, Object> kafkaTemplate,
