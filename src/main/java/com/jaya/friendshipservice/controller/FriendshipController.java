package com.jaya.friendshipservice.controller;

import com.jaya.friendshipservice.dto.BatchShareRequestItem;
import com.jaya.friendshipservice.dto.FriendshipResponseDTO;
import com.jaya.friendshipservice.dto.UserSummaryDTO;
...
public class FriendshipController {
    ...
    public ResponseEntity<List<UserSummaryDTO>> getBlockedUsers(
        ...
        List<UserSummaryDTO> Users = blockedUsers.stream()
    ...
    public ResponseEntity<List<UserSummaryDTO>> getFriendSuggestions(
        ...
        List<UserSummaryDTO> Users = suggestions.stream()
                .map(UserSummaryDTO::fromUser)
                .collect(Collectors.toList());
        return ResponseEntity.ok(Users);
    }
    ...
    public ResponseEntity<List<UserSummaryDTO>> getMutualFriends(
        ...
        List<UserSummaryDTO> Users = mutualFriends.stream()
                .map(UserSummaryDTO::fromUser)
                .collect(Collectors.toList());
        return ResponseEntity.ok(Users);
    }
    ...
    public ResponseEntity<List<UserSummaryDTO>> searchFriends(
        ...
        List<UserSummaryDTO> Users = friends.stream()
                .map(UserSummaryDTO::fromUser)
                .collect(Collectors.toList());
        return ResponseEntity.ok(Users);
    }
