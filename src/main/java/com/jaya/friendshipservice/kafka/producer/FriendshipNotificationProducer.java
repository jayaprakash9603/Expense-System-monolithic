package com.jaya.friendshipservice.kafka.producer;
...
public class FriendshipNotificationProducer extends NotificationEventProducer<FriendshipNotificationEvent> {
    ...
    public FriendshipNotificationProducer(@Qualifier("friendshipKafkaTemplate") KafkaTemplate<String, Object> kafkaTemplate,
