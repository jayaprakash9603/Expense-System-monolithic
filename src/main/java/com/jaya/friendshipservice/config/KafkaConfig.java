 ...
 */
@Configuration("friendshipKafkaConfig")
public class KafkaConfig {
     ...
     */
    @Bean(name = "friendshipProducerFactory")
    public ProducerFactory<String, Object> friendshipProducerFactory() {
     ...
     */
    @Bean(name = "friendshipKafkaTemplate")
    public KafkaTemplate<String, Object> friendshipKafkaTemplate() {
     ...
     */
    @Bean(name = "friendshipObjectMapper")
    public ObjectMapper friendshipObjectMapper() {
