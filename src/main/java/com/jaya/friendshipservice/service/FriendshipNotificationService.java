...
import com.jaya.friendshipservice.kafka.events.FriendshipNotificationEvent;
import com.jaya.friendshipservice.kafka.producer.FriendshipNotificationProducer;
...
public class FriendshipNotificationService {
     ...
     */
    @Async
    public void sendFriendRequestSentNotification(Friendship friendship, User requester) {
        try {
     ...
     */
    @Async
    public void sendFriendRequestAcceptedNotification(Friendship friendship, User acceptor) {
        try {
     ...
     */
    @Async
    public void sendFriendRequestRejectedNotification(Friendship friendship, User rejector) {
        try {
     ...
     */
    @Async
    public void sendFriendRequestCancelledNotification(Friendship friendship, User canceller) {
        try {
     ...
     */
    @Async
    public void sendFriendshipRemovedNotification(Friendship friendship, User remover, Integer otherId) {
        try {
     ...
     */
    @Async
    public void sendAccessLevelChangedNotification(Friendship friendship, User changer,
     ...
     */
    @Async
    public void sendUserBlockedNotification(Integer friendshipId, User blocker, Integer blockedId) {
        try {
     ...
     */
    @Async
    public void sendUserUnblockedNotification(Integer friendshipId, User unblocker, Integer unblockedId) {
        try {
     ...
     */
    private Map<String, Object> buildFriendRequestMetadata(Friendship friendship, User requester) {
     ...
     */
    private Map<String, Object> buildAcceptedMetadata(Friendship friendship, User acceptor) {
        Map<String, Object> metadata = new HashMap<>();
     ...
     */
    private Map<String, Object> buildRejectedMetadata(Friendship friendship, User rejector) {
        Map<String, Object> metadata = new HashMap<>();
     ...
     */
    private Map<String, Object> buildCancelledMetadata(Friendship friendship, User canceller) {
        Map<String, Object> metadata = new HashMap<>();
     ...
     */
    private Map<String, Object> buildRemovedMetadata(Friendship friendship, User remover) {
        Map<String, Object> metadata = new HashMap<>();
     ...
     */
    private Map<String, Object> buildAccessChangedMetadata(Friendship friendship, User changer,
     ...
     */
    private Map<String, Object> buildBlockedMetadata(User blocker, Integer blockedId) {
        Map<String, Object> metadata = new HashMap<>();
     ...
     */
    private Map<String, Object> buildUnblockedMetadata(User unblocker, Integer unblockedId) {
        Map<String, Object> metadata = new HashMap<>();
