package com.jaya.friendshipservice.mapper;


import com.jaya.friendshipservice.dto.GroupMemberDTO;
import com.jaya.friendshipservice.dto.GroupRequestDTO;
import com.jaya.friendshipservice.dto.GroupResponseDTO;
import com.jaya.friendshipservice.dto.GroupUpdateDTO;
import com.jaya.friendshipservice.models.Group;
...
public class GroupMapper {
    ...
    public GroupResponseDTO toResponseDTO(Group group, Integer currentUserId) throws Exception {
        ...
        try {
            User creator = helper.validateUser(group.getCreatedBy());
        ...
        return group.getMemberIds().stream()
                .map(memberId -> {
                    try {
                        ...
                        memberDTO.setImage(user.getProfileImage());
