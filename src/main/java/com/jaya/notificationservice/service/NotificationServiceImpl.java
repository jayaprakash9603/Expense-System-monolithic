...
import com.jaya.notificationservice.modal.*;
import com.jaya.notificationservice.repository.NotificationPreferencesRepository;
import com.jaya.notificationservice.repository.NotificationRepository;
...
public class NotificationServiceImpl implements NotificationService {
        ...
        @Override
        @Async
        public void sendBudgetExceededAlert(User user, BudgetDTO budget, double currentSpending) {
        ...
        @Override
        @Async
        public void sendBudgetWarningAlert(User user, BudgetDTO budget, double currentSpending,
        ...
        @Override
        @Async
        public void sendBudgetDTOExceededAlert(User user, BudgetDTO budget, double currentSpending) {
                NotificationPreferences prefs = getUserPreferences(user.getId());
                if (!prefs.getBudgetAlertsEnabled())
                        return;
        ...
        @Override
        @Async
        public void sendBudgetDTOWarningAlert(User user, BudgetDTO budget, double currentSpending,
                                              double warningThreshold) {
                NotificationPreferences prefs = getUserPreferences(user.getId());
                if (!prefs.getBudgetAlertsEnabled())
                        return;
        ...
        @Override
        @Async
        public void sendMonthlySpendingSummary(User user, LocalDate month) {
                NotificationPreferences prefs = getUserPreferences(user.getId());
        ...
        @Override
        @Async
        public void sendDailyExpenseDTOReminder(User user) {
                NotificationPreferences prefs = getUserPreferences(user.getId());
        ...
        @Override
        @Async
        public void sendWeeklyExpenseDTOReport(User user) {
                NotificationPreferences prefs = getUserPreferences(user.getId());
        ...
        @Override
        @Async
        public void sendUnusualSpendingAlert(User user, ExpenseDTO expense) {
                NotificationPreferences prefs = getUserPreferences(user.getId());
        ...
        @Override
        @Async
        public void sendRecurringExpenseDTOReminder(User user, List<ExpenseDTO> recurringExpenses) {
        ...
        @Override
        @Async
        public void sendGoalAchievementNotification(User user, String goalType, double targetAmount) {
                NotificationPreferences prefs = getUserPreferences(user.getId());
        ...
        @Override
        @Async
        public void sendInactivityReminder(User user, int daysSinceLastExpense) {
        ...
        @Override
        @Async
        public void scheduleMonthlyReports(User user) {
        ...
        @Override
        @Async
        public void sendCustomAlert(User user, String message, String alertType) {
        ...
        @Override
        public List<String> getNotificationHistory(User user, int limit) {
