...
import com.jaya.notificationservice.dto.events.*;
import com.jaya.notificationservice.service.processor.*;
...
public class BatchNotificationEventConsumer {
    ...
    /**
     * Converts payload (ConsumerRecord, LinkedHashMap, Map, or already-typed DTO) to DTO
     */
    private <T> T convertToDto(Object payload, Class<T> dtoClass) {
        try {
            ...
            // Convert Map/LinkedHashMap to DTO
            if (payload instanceof Map) {
                return objectMapper.convertValue(payload, dtoClass);
            }

            // If it's already the correct type, just cast
