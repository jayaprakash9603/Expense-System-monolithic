package com.jaya.auditservice.controller;




import com.jaya.auditservice.models.AuditExpense;
import com.jaya.auditservice.service.AuditExpenseService;
import com.jaya.userservice.modal.User;
import com.jaya.userservice.service.EmailService;
...
public class AuditExpenseController {
    ...
    @Autowired
    @org.springframework.beans.factory.annotation.Qualifier("userEmailService")
