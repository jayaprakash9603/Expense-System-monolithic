package com.jaya.budgetservice.kafka.producer;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.jaya.budgetservice.dto.BudgetNotificationEvent;
...
public class BudgetNotificationProducer extends NotificationEventProducer<BudgetNotificationEvent> {
    ...
    public BudgetNotificationProducer(@Qualifier("budgetKafkaTemplate") KafkaTemplate<String, Object> kafkaTemplate,
